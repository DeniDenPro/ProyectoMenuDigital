...
namespace TP_Restaurante.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        private readonly IGetOrdersByIdService _getOrderByIdService;
        public OrderController(ICreateOrderService createOrderService, IGetOrderFechaStatusService getOrderFechaStatusService, IUpdateOrderService updateOrderService, IUpdateOrderItemStatusService updateStatusService, IGetOrdersByIdService getOrderByIdService)
        {
